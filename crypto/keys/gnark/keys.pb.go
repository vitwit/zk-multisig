...
// source: cosmos/crypto/gnark/keys.proto
...
// PubKey defines a gnark verifying key.
// TODO describe
type PubKey struct {
...
func (*PubKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_4cc43c6b0ddd42c7, []int{0}
}
...
func (*PrivKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_4cc43c6b0ddd42c7, []int{1}
}
...
func init() {
	proto.RegisterType((*PubKey)(nil), "cosmos.crypto.gnark.PubKey")
	proto.RegisterType((*PrivKey)(nil), "cosmos.crypto.gnark.PrivKey")
}
